    ...
    <div className="mx-auto max-w-5xl px-4 py-12">
      ...
      <div className="grid gap-12 md:grid-cols-2">
        ...
        <section className="rounded-lg bg-white p-8 shadow-logo">
          ...
          {/* Second Location */}
          <div className="mb-6">
            <h3 className="mb-4 text-xl font-semibold text-logo-800">Second Location (Now Open)</h3>
            <div className="mb-4">
              <h4 className="mb-2 font-medium text-logo-800">Address:</h4>
              <address className="text-logo-700 not-italic">
      ...
      <section className="mt-12 rounded-lg bg-white p-2 shadow-logo">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          {/* Second Location Map */}
          <div>
            <h3 className="mb-4 text-xl font-semibold text-logo-800 text-center">Second Location (Now Open)</h3>
            <div className="aspect-video w-full">
              <iframe 
