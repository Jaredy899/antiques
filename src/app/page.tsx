...
export default function HomePage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <section className="py-4 bg-white dark:bg-gray-900 transition-colors duration-200">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg transition-colors duration-200">
            <div className="text-center">
              <h2 className="text-3xl font-serif font-bold mb-6 text-gray-900 dark:text-white">Stay Connected!</h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a 
                  ...
                  className="inline-flex items-center gap-2 rounded-md bg-[#1877F2] px-5 py-2.5 text-white shadow-sm transition-all hover:bg-[#166FE5] focus:ring-2 focus:ring-[#1877F2]/50 no-underline"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-md bg-[#E4405F] px-5 py-2.5 text-white shadow-sm transition-all hover:bg-[#D63256] focus:ring-2 focus:ring-[#E4405F]/50 no-underline"
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="rounded-xl bg-gray-100 dark:bg-gray-800 p-8 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <Link 
                  href="/information" 
                  className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-md transition-colors duration-200 no-underline"
                >
                  Visit Our Store
                </Link>
              </div>
