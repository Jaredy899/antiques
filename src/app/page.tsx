...
export default function HomePage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      {/* Hero Section */}
      <section className="mb-16 rounded-lg bg-logo-50 p-8 shadow-logo">
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div>
            <h1 className="mb-4 text-4xl font-bold text-logo-800 md:text-5xl text-center font-serif">
              Welcome to Abingdon Antiques and More
            </h1>
            <p className="mb-6 text-lg text-logo-700 text-center">
            ...
            <div className="mt-4 text-center">
              <span className="font-medium text-logo-700">Follow us:</span>
              <p className="text-logo-600 text-sm mt-1 mb-2">Stay connected for the latest treasures and antique finds!</p>
              <div className="mt-2 flex space-x-4 justify-center">
                <a 
                  href="https://www.facebook.com/profile.php?id=61551934216826" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-logo-700 hover:text-logo-800 transition-colors"
                  aria-label="Facebook"
                >
                  <svg
      ...
      <section className="mb-16">
        <h2 className="mb-8 text-center text-3xl font-bold text-logo-800 font-serif">Featured Categories</h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {["Furniture", "Jewelry", "Art", "Collectibles", "China & Glassware", "Home Decor"].map((category) => (
            <div key={category} className="rounded-lg bg-white p-4 shadow-md transition-all hover:shadow-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-logo-900 font-serif">{category}</h3>
              <p className="text-logo-700">
        ...
        <div className="mt-8 text-center">
          <Link 
            href="/antiques"
            className="inline-block rounded-md bg-logo-600 px-6 py-3 text-white shadow-sm transition-all hover:bg-logo-700 focus:ring-2 focus:ring-logo-300"
          >
            View All Antiques
          </Link>
        </div>
